/**
 * org-settings-domain-verification.spec.js
 *
 * Captures a full-page screenshot of the Organization Settings > Claimed domains page.
 *
 * Requires:
...
const outputPath = resolve(__dirname, '../../output/web/adminconsole/org-settings-domain-verification.png');

const orgId = process.env.ORG_ID || '';
const baseURL = process.env.WEB_APP_URL || 'https://vault.bitwarden.com';

test('org settings domain verification - full page screenshot', async ({ page }) => {
  ...
  // Wait for spinner to detach, then wait for either the table or the empty state
