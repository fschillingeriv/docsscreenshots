 ...
 * sm-trash.spec.js
 *
 * Captures a screenshot of the Secrets Manager Trash page:
 *   - sm-trash.png  — Trash
 *
 * Requires:
...
test('sm trash', async ({ page }) => {
  await login(page);

  await page.goto(`${smBase}/trash`);
  await page.waitForSelector('sm-trash, bit-table, bit-section', { state: 'visible', timeout: 15000 });
  await page.waitForTimeout(500);
  await takeScreenshot(page, 'sm-trash.png');
});
