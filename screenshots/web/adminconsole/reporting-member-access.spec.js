/**
 * reporting-member-access.spec.js
 *
 * Captures a full-page screenshot of the Reporting > Member access report page.
 *
 * Requires:
...
const outputPath = resolve(__dirname, '../../../output/web/adminconsole/reporting-member-access.png');

const orgId = process.env.ORG_ID || '';
const baseURL = process.env.WEB_APP_URL || 'https://vault.bitwarden.com';

test('reporting member access - full page screenshot', async ({ page }) => {
  ...
  // Wait for the loading spinner to detach then the member table to render
