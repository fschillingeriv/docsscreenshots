/**
 * org-settings-export.spec.js
 *
 * Captures a full-page screenshot of the Organization Settings > Export page.
 *
 * Requires:
...
const outputPath = resolve(__dirname, '../../output/web/adminconsole/org-settings-export.png');

const orgId = process.env.ORG_ID || '';
const baseURL = process.env.WEB_APP_URL || 'https://vault.bitwarden.com';

test('org settings export - full page screenshot', async ({ page }) => {
