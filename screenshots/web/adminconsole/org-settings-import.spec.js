/**
 * org-settings-import.spec.js
 *
 * Captures a full-page screenshot of the Organization Settings > Import page.
 *
 * Requires:
...
const outputPath = resolve(__dirname, '../../output/web/adminconsole/org-settings-import.png');

const orgId = process.env.ORG_ID || '';
const baseURL = process.env.WEB_APP_URL || 'https://vault.bitwarden.com';

test('org settings import - full page screenshot', async ({ page }) => {
