/**
 * org-settings-sso.spec.js
 *
 * Captures a full-page screenshot of the Organization Settings > Single sign-on page.
 *
 * Requires:
...
const outputPath = resolve(__dirname, '../../../output/web/adminconsole/org-settings-sso.png');

const orgId = process.env.ORG_ID || '';
const baseURL = process.env.WEB_APP_URL || 'https://vault.bitwarden.com';

test('org settings sso - full page screenshot', async ({ page }) => {
  ...
  // Wait for the SSO form to render (isInitializing spinner detaches first)
