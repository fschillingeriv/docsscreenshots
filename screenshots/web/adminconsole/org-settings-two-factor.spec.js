/**
 * org-settings-two-factor.spec.js
 *
 * Captures a full-page screenshot of the Organization Settings > Two-step login page.
 *
 * Requires:
...
const outputPath = resolve(__dirname, '../../../output/web/adminconsole/org-settings-two-factor.png');

const orgId = process.env.ORG_ID || '';
const baseURL = process.env.WEB_APP_URL || 'https://vault.bitwarden.com';

test('org settings two-factor - full page screenshot', async ({ page }) => {
